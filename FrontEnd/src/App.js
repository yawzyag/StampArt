        ...
        <div className='d-flex flex-column' style={{ height: '100vh' }}>
          ...
          <div className='container'>
            <Switch>
              ...
              <Route path='/profile' render={(props) => <Profile {...props} user_name={this.state.user_name} user_address={this.state.user_address} email={this.state.email} onUserUpdate={this.handleInputUpdate} onClickUpdate={this.clickUpdate} />} />
              <>
